...
export default class DayView extends React.PureComponent {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    return {packedEvents: populateEvents(nextProps.events, width)};
  }
          ...
          {this.props.renderEvent ? (
            ...
            <TouchableOpacity
              ...
              <View style={styles.status}>
                ...
                {event.status === 2 && (
                  <Text
                    style={[styles.statusText, styles.statusOrange]}
                    numberOfLines={1}>
                    Đang Họp
                  </Text>
                )}
                {event.status === 3 && (
                  <Text
                    style={[styles.statusText, styles.statusRed]}
                    numberOfLines={1}>
                    Sắp tới
                  </Text>
                )}
